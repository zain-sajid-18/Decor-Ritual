      ...
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8 space-y-10">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-12">
          ...
          <div className="md:col-span-6 space-y-4">
            ...
            {/* FTC-required conspicuous disclosure — must appear near affiliate links */}
        ...
        <div className="border-t border-stone-200/60 pt-6 dark:border-stone-800/60 space-y-3">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3 text-[11px] text-stone-400 dark:text-stone-600 pt-2">
            <p>© {new Date().getFullYear()} Decor Ritual. Curated with intention.</p>
            <p>All purchases fulfilled by Amazon.com</p>
          </div>
        </div>
      </div>
    </footer>
